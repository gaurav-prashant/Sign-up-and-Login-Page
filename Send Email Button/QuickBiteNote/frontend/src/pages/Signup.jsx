    ...
    const handleSubmit = async(e)=>{
        ...
        try {
            ...
            if(res.data.success){
                ...
                toast.success("Account created & automatically verified!")
            }
        } catch (error) {
            console.log(error);
            const errorMessage = error.response?.data?.message || error.response?.data?.errors?.[0] || "Something went wrong during signup!";
                    ...
                    <div className='w-full max-w-md space-y-6'>
                        ...
                        <Card className="w-full max-w-sm">
                            ...
                            <div className="mt-4 text-center">
                                <button onClick={() => navigate('/login')}>Already have an account? <span className='text-green-600 text-bold '>Login</span></button>
                            </div>
                        </Card>
                    </div>
                </div>
